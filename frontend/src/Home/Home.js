...
const HomePage = ({ alert }, props) => {
  ...
  const handleSubmit = () => {
    if (text) {
      ...
      alert.error("Please make sure to either insert your Terms and Conditions into the textfield or add the file with the content you would like to be analyzed.", {
      ...
      <div className="container" id="container">
        <div className="row justify-content-center text-center h-100 m-0 p-0">
          ...
          <div className="col-6 my-auto">
            <TextField
              id="outlined-basic"
              label="Paste the Terms and Conditions here ..."
              variant="outlined"
